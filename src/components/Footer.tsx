    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-5">
            <Link to="/" className="flex items-center gap-2.5 group cursor-pointer">
              ...
              <span className="font-display font-black text-lg sm:text-xl tracking-tight text-white group-hover:text-harmony-turquoise transition-colors duration-200">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3.5 text-sm">
              ...
              <li>
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-harmony-turquoise/40" />
                  <span>About Jadon Pharmaceuticals India Private Limited</span>
                </Link>
              </li>
              <li>
                <Link
        ...
        <div className="mt-16 pt-8 border-t border-harmony-teal/20 text-center text-xs text-harmony-cream/65 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© {currentYear} Jadon Pharmaceuticals India Private Limited. All rights reserved.</p>
