...
export function SEOHead({ title, description }: SEOHeadProps) {
  ...
  useEffect(() => {
    const defaultTitle = 'Jadon Pharmaceuticals India Private Limited - Wholesale Pharmaceutical Distributor';
    const siteTitle = title ? `${title} | Jadon Pharmaceuticals India Private Limited` : defaultTitle;
    ...
    setMetaTag('og:site_name', 'Jadon Pharmaceuticals India Private Limited');
    ...
    schemaScript.textContent = JSON.stringify({
      ...
      'alternateName': 'Jadon Pharmaceuticals India Private Limited Wholesale',
