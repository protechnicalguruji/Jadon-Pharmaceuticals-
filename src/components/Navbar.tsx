      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col max-w-[190px] xs:max-w-[240px] sm:max-w-xs md:max-w-sm lg:max-w-md">
              <span className="font-display font-bold text-sm sm:text-base lg:text-lg tracking-tight text-white group-hover:text-harmony-cream transition-colors duration-300 truncate">
