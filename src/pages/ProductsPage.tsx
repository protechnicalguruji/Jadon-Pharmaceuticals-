...
export function ProductsPage() {
  ...
  const handleWhatsAppInquiry = (product: Product, quantity = 1) => {
    const text = `Hello Jadon Pharmaceuticals India Private Limited , I would like to place an order inquiry for:
  ...
  return (
    ...
    >
      <SEOHead
        ...
        description="Explore 190+ WHO-GMP certified pharmaceutical formulations, ICU plasma, specialty therapeutics, and antibiotics at direct wholesale pricing from Jadon Pharmaceuticals India Private Limited ."
      />
      ...
      <div className="bg-harmony-dark text-white rounded-3xl p-8 sm:p-12 border border-harmony-teal/30 shadow-2xl relative overflow-hidden">
        <div className="relative z-10 max-w-3xl space-y-3">
          ...
          <p className="text-slate-300 text-sm sm:text-base font-normal leading-relaxed">
            Factory-direct pricing on ICU, plasma formulations, critical care, and broad-spectrum antibiotics supplied by Jadon Pharmaceuticals India Private Limited and Senores Pharmaceuticals Limited.
          </p>
        </div>
      </div>
