  ...
  return (
    ...
    >
      <SEOHead
        ...
        description={`Order ${product.brandName} (${product.description}) at wholesale price ₹${product.wholesalePrice} from Jadon Pharmaceuticals India Private Limited . CDSCO verified batch distribution.`}
      />
