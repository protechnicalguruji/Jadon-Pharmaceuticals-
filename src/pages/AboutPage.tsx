...
export function AboutPage() {
  return (
    ...
    >
      <SEOHead
        title="About Jadon Pharmaceuticals India Private Limited - Licensed Pharmaceutical Wholesaler"
        description="Learn about Jadon Pharmaceuticals India Private Limited , a CDSCO-licensed pharmaceutical distributor supplying hospital-grade critical care, plasma therapeutics, and WHO-GDP compliant cold-chain distribution across India."
      />
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 overflow-hidden bg-gradient-to-tr from-slate-950 via-harmony-dark to-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-3xl">
          ...
          >
            Jadon Pharmaceuticals India Private Limited serves as a primary pharmaceutical distribution channel, ensuring authentic, cold-chain compliant therapeutics reach hospitals, clinics, and pharmacies with zero delay.
          </motion.p>
        </div>
      </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-harmony-dark/85 text-sm sm:text-base leading-relaxed">
              Founded with a commitment to bridge manufacturing excellence with critical healthcare delivery, Jadon Pharmaceuticals India Private Limited operates state-of-the-art WHO-GDP compliant warehousing facilities in Gwalior, Madhya Pradesh.
            </p>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-harmony-teal/20 shadow-xl aspect-4/3">
            <img
              ...
              alt="Jadon Pharmaceuticals India Private Limited distribution warehouse"
        ...
        <section className="bg-harmony-dark text-white rounded-3xl p-8 sm:p-12 border border-harmony-teal/30 shadow-2xl space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-sm text-slate-300">
              Jadon Pharmaceuticals India Private Limited maintains strict adherence to CDSCO standards, wholesale licensing laws, and DSCA guidelines.
            </p>
          </div>
