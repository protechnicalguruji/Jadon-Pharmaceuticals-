    ...
    >
      ...
      <div className="bg-grid-pattern py-16 md:py-24 space-y-16 md:space-y-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <section id="master-bento-section" className="space-y-12">
          ...
          >
            {/* Bento Card 1: About Jadon Pharmaceuticals India Private Limited */}
            <motion.div
              id="bento-card-about"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-harmony-dark font-display group-hover:text-harmony-teal transition-colors">
                    About Jadon Pharmaceuticals India Private Limited 
                  </h3>
                  <p className="text-harmony-dark/85 text-sm sm:text-base leading-relaxed font-normal">
                    Jadon Pharmaceuticals India Private Limited operates as an established, regulated pharmaceutical wholesale partner supplying hospital-grade formulations, critical care, plasma, and specialty therapeutics across India.
                  </p>
                </div>
                ...
                <div className="relative rounded-2xl overflow-hidden aspect-16/9 border border-harmony-teal/15 shadow-inner">
                  <img
                    ...
                    alt="Jadon Pharmaceuticals India Private Limited modern sterile laboratory equipment"
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
            <div className="space-y-2">
              ...
              <p className="text-harmony-dark/80 text-sm sm:text-base font-normal">
                Direct wholesale pricing on high-volume ICU, plasma, and specialty formulations supplied by Jadon Pharmaceuticals India Private Limited and Senores Pharmaceuticals Limited.
              </p>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {featuredProducts.map((product) => {
              const whatsappMsg = encodeURIComponent(
                `Hello Jadon Pharmaceuticals India Private Limited , I would like to inquire about wholesale order for ${product.brandName} (${product.description}). Please confirm current stock and dispatch timeline.`
              );
