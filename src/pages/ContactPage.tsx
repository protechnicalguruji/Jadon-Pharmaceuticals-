  ...
  return (
    ...
    >
      <SEOHead
        ...
        description="Contact Jadon Pharmaceuticals India Private Limited for wholesale drug inquiries, cold-chain distribution partnerships, and hospital supply agreements. Phone: +91 88106 60831."
      />
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 overflow-hidden bg-gradient-to-tr from-slate-950 via-harmony-dark to-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-2xl">
          ...
          >
            Contact Jadon Pharmaceuticals India Private Limited 
          </motion.h1>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-harmony-card p-6 sm:p-8 rounded-3xl border border-harmony-teal/20 shadow-sm space-y-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                {/* WhatsApp Card */}
                <a
                  href={`https://wa.me/${CONTACT_INFO.whatsapp}?text=${encodeURIComponent('Hello Jadon Pharmaceuticals India Private Limited , I would like to make an inquiry.')}`}
                  target="_blank"
            ...
            <div className="bg-harmony-card p-6 sm:p-10 rounded-3xl border border-harmony-teal/20 shadow-xl space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-600">
                  Fill out the form below to receive a formal wholesale quote, catalog price list, or distribution terms for Jadon Pharmaceuticals India Private Limited .
                </p>
              </div>
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-xs text-emerald-800 max-w-md mx-auto leading-relaxed">
                      Thank you for contacting Jadon Pharmaceuticals India Private Limited . Our sales and clinical dispatch team has received your message and will get back to you within 2 to 4 business hours.
                    </p>
                    <button
